...
- `symaira-core-config`: the Rust loader now follows that current zero-value
  precedence. The original v0.17.0 Go oracle fixture remains immutable as
  historical evidence of the previous behavior.
