// Package extract provides safe archive extraction (tar.gz and zip) for
// self-update workflows, with path-traversal protection and configurable
// binary detection.
package extract
...
// absolute path or contain a parent-directory traversal segment. Containment
// is additionally enforced at the syscall level by os.Root in
